package week3.nio02.outbound.httpclient;
...
public class HttpOutboundHandler4Test {

    private CloseableHttpClient httpClient;
    private String outboundUrl;

    public HttpOutboundHandler4Test(String outboundUrl) {
...
//            byte[] body = EntityUtils.toByteArray(endpointResponse.getEntity());
            String value = "hello,just for test";
